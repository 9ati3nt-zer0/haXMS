...
if (is_numeric($_GET['id']) == true) {
    ...
    $all = mysql_query("SELECT * FROM `mission_table` WHERE `id`='$id'") or die(mysql_error());
    ...
    require('interface/db_core.php');
    $all = mysql_query("SELECT * FROM `mission_table` ORDER BY `id`") or die(mysql_error());
    ?>
    ...
    <td><div align="center">Mission&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
    ...
    <?php while ($row = mysql_fetch_array($all)) {
        ...
        <td><div align="center"><a href="?id=<?php echo $row['id'];?>"><?php echo stripslashes($row['mission']);?></a>
        &nbsp;
        &nbsp;
        &nbsp;
        &nbsp;
